...
function highestPercentageStudents(certain_mark){
    ...
    for(let subject in subjects){
        ...
        if(percentage>subject_percentge){
...
console.log(highestPercentageStudents(30))

module.exports=highestPercentageStudents
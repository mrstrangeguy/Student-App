...
// function to find and print the subject(s) in which the lowest percentage of students scored above the average marks of a specific student.
...
function subjectsAboveStudent(specific_student){
    ...
    let highestPercentage=-1
      for(let subject in subjects){
        ...
        if(highestPercentage===-1||percentage<highestPercentage){
...
console.log(subjectsAboveStudent("Binu"))

...
//function to find and print the subject(s) in which the majority of students scored above the average marks of the class.

function belowAverageSubjects(){
...
console.log(belowAverageSubjects())

module.exports=belowAverageSubjects